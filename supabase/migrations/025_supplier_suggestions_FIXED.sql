...
-- =====================================================
-- VERSÃO CORRIGIDA - Drop e recria as funções
-- =====================================================

-- =====================================================
-- 1. DROP funções antigas (se existirem)
-- =====================================================

DROP FUNCTION IF EXISTS get_nearby_suppliers(DOUBLE PRECISION, DOUBLE PRECISION, INTEGER, TEXT[]);
DROP FUNCTION IF EXISTS calculate_supplier_score(UUID, DOUBLE PRECISION, DOUBLE PRECISION, TEXT[]);
DROP FUNCTION IF EXISTS get_suggested_suppliers(DOUBLE PRECISION, DOUBLE PRECISION, TEXT[], INTEGER, NUMERIC, INTEGER);

-- =====================================================
-- 2. FUNÇÃO: get_nearby_suppliers
-- =====================================================
...
-- =====================================================
-- 3. FUNÇÃO: calculate_supplier_score
-- =====================================================
...
-- =====================================================
-- 4. FUNÇÃO: get_suggested_suppliers
-- =====================================================
